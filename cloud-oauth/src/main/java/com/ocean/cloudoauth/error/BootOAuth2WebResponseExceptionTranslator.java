package com.ocean.cloudoauth.error;
 ...
 */
@Slf4j
public class BootOAuth2WebResponseExceptionTranslator implements WebResponseExceptionTranslator<OAuth2Exception>, Serializable {
